...
static void llm_load_vocab(
    ...
    // determine vocab type
    {
        ...
        fprintf(stderr, "tokenizer_model: %s\n", tokenizer_model.c_str());
...
struct llm_build_context {
    ...
    const llm_build_cb & cb,
        ...
        n_ctx_orig       (cparams.n_yarn_orig_ctx),
...
static struct ggml_cgraph * llama_build_graph(
    ...
    llm.init();
/*
    if (llm.model.arch == LLM_ARCH_LLAMA)
        fprintf(stderr, "mylog: model arch llama\n"); 
    else 
        fprintf(stderr, "mylog: model arch not llama\n");
*/
